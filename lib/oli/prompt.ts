...
export function buildOliStackPrompt(stack: OliSpecialistStack): string {
  ...
  return [
    ...
    '',
    'Oli Hub core rooms:',
    '- Mothership Vault: use authorized source/project/design/evidence records and preserve originals and approved-version lineage.',
    '- Manifesto + Living Blueprint Scribe: read current applicable governance before consequential work; propose addenda rather than silently rewriting canon.',
    ...
    '- Source Intelligence: use verified capability, connection, permission, subscription, and limitation state for routing.',
    '',
