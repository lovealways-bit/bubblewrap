import type { OliSpecialistStack, OliStackId } from './types'
...
export const OLI_SPECIALIST_STACKS: Record<OliStackId, OliSpecialistStack> = {
  web: {
    ...
    actionGates: [
      ...
      },
      {
        ...
        requiresExplicitUserPermission: true,
        prohibited: true,
        note: 'Subscription-first governance requires founder approval before new spend.',
      },
    ],
    systemRules: [
  ...
  medical: {
    ...
    systemRules: [
      ...
      'Use the user own records only when access is authenticated and authorized.',
...
export function getOliStack(id: OliStackId): OliSpecialistStack {
  return OLI_SPECIALIST_STACKS[id]
}

export function listOliStacks(): OliSpecialistStack[] {
